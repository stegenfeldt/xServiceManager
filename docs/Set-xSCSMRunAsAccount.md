...
```
Set-xSCSMRunAsAccount -SecureReferences <ManagementPackSecureReference[]> [-WindowsCredential] <PSCredential>
...
### -SecureReferences
{{ Fill SecureReferences Description }}
