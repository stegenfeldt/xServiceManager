...
### Name (Default)
```
Get-xSCSMImage [-ListOnly] [[-Name] <String[]>] [-ComputerName <String>] [-Credential <PSCredential>]
...
### Id
```
Get-xSCSMImage [-ListOnly] [[-Id] <Guid>] [-ComputerName <String>] [-Credential <PSCredential>]
 [-SCSMSession <EnterpriseManagementGroup>] [-ThreeLetterWindowsLanguageName <String>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### DisplayName
```
Get-xSCSMImage [-ListOnly] [[-DisplayName] <String>] [-ComputerName <String>] [-Credential <PSCredential>]
 [-SCSMSession <EnterpriseManagementGroup>] [-ThreeLetterWindowsLanguageName <String>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
