...
```
New-xSCSMColumn -Name <String> -BindingPath <String> [-DisplayName <String>] [-Width <String>]
 [-DataType <String>] [-PassThru] [-ComputerName <String>] [-Credential <PSCredential>]
