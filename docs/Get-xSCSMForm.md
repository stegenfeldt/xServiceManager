...
### Name (Default)
```
Get-xSCSMForm [[-Target] <ManagementPackElement>] [[-Name] <String[]>] [-ComputerName <String>]
...
### Id
```
Get-xSCSMForm [[-Target] <ManagementPackElement>] [[-Id] <Guid>] [-ComputerName <String>]
 [-Credential <PSCredential>] [-SCSMSession <EnterpriseManagementGroup>]
 [-ThreeLetterWindowsLanguageName <String>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### DisplayName
```
Get-xSCSMForm [[-Target] <ManagementPackElement>] [[-DisplayName] <String>] [-ComputerName <String>]
 [-Credential <PSCredential>] [-SCSMSession <EnterpriseManagementGroup>]
 [-ThreeLetterWindowsLanguageName <String>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
