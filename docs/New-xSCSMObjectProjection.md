...
```
New-xSCSMObjectProjection [-Type] <String> [-Projection] <Hashtable> [-Template <ManagementPackObjectTemplate>]
 [-PassThru] [-Bulk] [-NoCommit] [-QueryOption <ObjectQueryOptions>] [-ComputerName <String>]
