...
### HIERARCHY (Default)
```
Get-xSCSMFolderHierarchy [-Folder] <ManagementPackFolder[]> [-QueryOption <ObjectQueryOptions>]
...
### ROOT
```
Get-xSCSMFolderHierarchy [-Root] [-QueryOption <ObjectQueryOptions>] [-ComputerName <String>]
