...
### Guid (Default)
```
Get-xSCSMTask [[-Id] <Guid>] [-QueryOption <ObjectQueryOptions>] [-ComputerName <String>]
...
### Criteria
```
Get-xSCSMTask [[-Criteria] <ManagementPackTaskCriteria>] [-QueryOption <ObjectQueryOptions>]
...
```yaml
Type: Microsoft.EnterpriseManagement.Configuration.ManagementPackTaskCriteria
