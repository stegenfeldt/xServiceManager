...
```
New-xSCSMAnnouncement [-DisplayName] <String> [-Body] <String> [[-Priority] <String>]
 [-ExpirationDate] <DateTime> [-PassThru] [-ComputerName <String>] [-Credential <PSCredential>]
...
### -DisplayName
The title of the annoucncement.
