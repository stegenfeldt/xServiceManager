...
```
Get-xSCSMChildEnumeration [-Depth <TraversalDepth>] [-Enumeration] <ManagementPackEnumeration>
 [[-Name] <String>] [-ComputerName <String>] [-Credential <PSCredential>]
...
### -Enumeration
{{ Fill Enumeration Description }}

```yaml
Type: Microsoft.EnterpriseManagement.Configuration.ManagementPackEnumeration
Parameter Sets: (All)
Aliases:
